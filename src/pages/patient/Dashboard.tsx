          ...
          <div className="ayur-card mb-6 bg-gradient-to-r from-herb/10 to-primary/10 border-herb/20">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground">Condition: {patient.disease}</p>
                {patient.symptoms && <p className="text-sm text-muted-foreground">Symptoms: {patient.symptoms}</p>}
              </div>
            </div>
          </div>
        )}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="ayur-card">
            ...
            {dietPlans.length > 0 ? (
              ...
              <p className="text-muted-foreground text-center py-8">No diet plans yet</p>
            )}
          </div>
        </div>
      </main>
